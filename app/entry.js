...
let portfolioApp = angular.module('portfolioApp', [require('angular-route'), require('ngclipboard'), require('angular-touch'), require('angular-ui-bootstrap'), require('angular-animate')]);
